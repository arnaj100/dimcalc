...
public class DimCalc extends AppCompatActivity implements View.OnClickListener {
    ...
    private edu.up.dimcalc.TwoPoints twoPoints = new TwoPoints();
    ...
    public void onClick(View v) {
        ...
        int id = v.getId();
        if(id == R.id.rand1Button) {
            twoPoints.randomValue(0);
        }
        else if(id == R.id.origin1Button) {
            twoPoints.setOrigin(0);
        }
        else if(id == R.id.rand2Button) {
            twoPoints.randomValue(1);
        }
        else if(id == R.id.origin2Button) {
            twoPoints.setOrigin(1);
        }
        else if(id == R.id.copy1Button) {
            twoPoints.copy(1, 0);
        }
        else if(id == R.id.copy2Button) {
            twoPoints.copy(0, 1);
        }
        else if(id == R.id.distanceButton) {
            result = "" + twoPoints.distance();
        }
        else if(id == R.id.slopeButton) {
